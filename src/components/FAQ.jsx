      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="text-center mb-16 px-2" data-aos="fade-down">
          ...
          <p className="mt-4 text-sm sm:text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            {t.faq.subtitle ||
              "Aclarando tus dudas para comenzar con tranquilidad."}
          </p>
        </div>

        <div
          className="max-w-3xl mx-auto space-y-4 px-2 sm:px-0"
          data-aos="fade-up"
        >
          {faqs.map((faq, index) => (
            <div
            ...
            >
              <button
                ...
                className="w-full flex justify-between items-center text-left text-base sm:text-lg md:text-xl font-display p-4 sm:p-6 text-gray-800 dark:text-white hover:bg-gray-50 dark:hover:bg-gray-600 transition"
              >
              ...
              <div
                className={`faq-answer px-4 sm:px-6 pb-4 sm:pb-6 text-sm sm:text-lg text-gray-600 dark:text-gray-300 transition-all duration-400 overflow-hidden ${
                  openIndex === index

...
export const translations = {
  es: {
    ...
    contact: {
      ...
      subtitle: "Hablemos sobre cómo podemos transformar tu espacio.",
      ...
      modal: {
        ...
        privacyPolicy: {
          ...
          body: `<strong>Responsable del tratamiento</strong>
                    ...
                    • Responder a solicitudes de información y elaboración de presupuestos.
                    • Gestionar la relación comercial y la prestación de los servicios contratados.
                    • Enviar comunicaciones sobre servicios de pintura y mantenimiento (solo con consentimiento).
                    ...
                    Los datos se conservarán mientras dure la relación comercial y, posteriormente, el tiempo necesario para cumplir obligaciones legales.

                    <strong>Cesiones de datos</strong>
        ...
        cookiesPolicy: {
          ...
          body: `Este sitio web utiliza cookies para garantizar el correcto funcionamiento y mejorar la experiencia del usuario.
                    ...
                    <strong>Cookies analíticas:</strong> permiten analizar el tráfico y uso de la web.
                    <strong>Cookies de terceros:</strong> por ejemplo, Google Analytics.
        ...
        termsConditions: {
          ...
          body: `<strong>Objeto</strong>
                    ...
                    <strong>Presupuestos y contratación</strong>
                     • Los presupuestos emitidos tienen una validez de 30 días.
                     • La contratación se formalizará mediante la aceptación expresa del presupuesto.

                    <strong>Precios y formas de pago</strong>
                     • Los precios incluyen IVA, salvo indicación contraria.
                     • Formas de pago aceptadas: transferencia bancaria, tarjeta, efectivo.

                    <strong>Plazos de ejecución</strong>
                     • Los plazos se establecerán en cada contrato o presupuesto.
                     • Pinturas Pro no se responsabiliza de retrasos ocasionados por causas de fuerza mayor.

                    <strong>Garantías</strong>
                    Los trabajos realizados cuentan con garantía de [X meses/años] frente a defectos de aplicación o acabado.
  ...
  ca: {
    ...
    faq: {
      ...
      subtitle: "Aclarant les teves dubtes per començar amb tranquil·litat.",
      q1: "¿Ofereixeu pressupost sense compromís?",
      a1: "Sí, visitem la vostra propietat sense cost i us enviarem un pressupost detallat en 24 hores.",
    ...
    contact: {
      ...
      subtitle: "Parlem de com podem transformar el teu espai.",
      name: "Nom complet",
    ...
    footer: {
      ...
      modal: {
        legalNotice: {
          title: "Avís Legal",
          body: `<strong>Titularitat del lloc web:</strong>
            - Denominació social: Pintures Pro
            - NIF/CIF: [indicar]
            - Domicili social: [indicar]
            - Telèfon: [indicar]
            - Correu electrònic: [indicar]

            <strong>Condicions d'ús</strong>
            L'accés i ús d'aquest lloc web atribueix la condició d'usuari i implica l'acceptació d'aquestes condicions. L'usuari es compromet a utilitzar el lloc web de manera adequada, sense realitzar activitats il·legals, contràries a la bona fe o que puguin perjudicar tercers.

            <strong>Propietat intel·lectual i industrial</strong>
            Els continguts, textos, imatges, logotips i disseny d'aquest lloc web són propietat de Pintures Pro o dels seus autors legítims. Queda prohibit la reproducció, distribució, comunicació pública o modificació d'aquests continguts sense autorització expressa.
        ...
        cookiesPolicy: {
          ...
          body: `
            Aquest lloc web utilitza galetes per garantir el funcionament correcte i millorar l'experiència de l'usuari.

            <strong>Tipus de galetes utilitzades</strong><br><br>
            <strong>Galetes tècniques:</strong> necessàries per al funcionament del lloc.<br>
            <strong>Galetes analítiques:</strong> permeten analitzar el trànsit i ús del web.<br>
            <strong>Galetes de tercers:</strong> per exemple, Google Analytics.<br><br>
        ...
        termsConditions: {
          ...
          body: `
            <strong>Objecte</strong><br><br>
            Aquestes condicions regulen la contractació de serveis de pintura per a habitatges, comunitats i edificis oferts per Pintures Pro.<br><br>

            <strong>Pressupostos i contractació</strong><br><br>
            • Els pressupostos emesos tenen una validesa de 30 dies.<br>
            • La contractació es formalitzarà mitjançant l'acceptació expressa del pressupost.<br><br>

            <strong>Preus i formes de pagament</strong><br><br>
            • Els preus inclouen IVA, llevat d'indicació contrària.<br>
            • Formes de pagament acceptades: transferència bancària, targeta, efectiu.<br><br>

            <strong>Plaços d'execució</strong><br><br>
            • Els plaços s'establiran a cada contracte o pressupost.<br>
            • Pintures Pro no es farà responsable de retards causats per causes de força major.<br><br>

            <strong>Garanties</strong><br><br>
            Els treballs realitzats comten amb garantia de [X mesos/anys] contra defectes d'aplicació o acabat.<br><br>
  ...
  en: {
    ...
    services: {
      title: "Our Services",
      desc: "From homes to commercial buildings, we offer complete solutions.",
      included: "Includes cleaning",
    },
    blog: {
      title: "Tips & Trends",
    ...
    faq: {
      ...
      subtitle: "Clarifying your doubts to start with peace of mind.",
      q1: "Do you offer free estimates?",
      a1: "Yes, we visit your property at no cost and send you a detailed quote within 24 hours.",
      ...
      modal: {
        legalNotice: {
          ...
          body: `
            ...
            Accessing and using this website grants you the status of user and implies acceptance of these terms. The user agrees to use the website appropriately, without engaging in illegal activities, acts contrary to good faith, or actions that may harm third parties.

            <strong>Intellectual and Industrial Property</strong>
            All content, texts, images, logos, and design on this website are the property of Pinturas Pro or their legitimate authors. Reproduction, distribution, public communication, or modification of such content is strictly prohibited without prior written authorization.
        ...
        cookiesPolicy: {
          ...
          body: `
            ...
            <strong>Technical Cookies:</strong> essential for the website to function.<br>
            <strong>Analytical Cookies:</strong> allow us to analyze traffic and usage patterns.<br>
            <strong>Third-Party Cookies:</strong> for example, Google Analytics.<br><br>
      ...
      `,
        ...
        termsConditions: {
          ...
          body: `
            ...
            <strong>Quotes and Contracting</strong><br><br>
            • Quotes issued are valid for 30 days.<br>
            • Contracts are confirmed upon explicit acceptance of the quote.<br><br>

            <strong>Pricing and Payment Methods</strong><br><br>
            • Prices include VAT unless otherwise stated.<br>
            • Accepted payment methods: bank transfer, credit card, cash.<br><br>

            <strong>Service Timelines</strong><br><br>
            • Deadlines will be specified in each quote or contract.<br>
            • Pinturas Pro is not liable for delays caused by force majeure.<br><br>

            <strong>Warranties</strong><br><br>
            Work is covered by a warranty of [X months/years] against application or finish defects.<br><br>
